  ...
  Widget build(BuildContext context) {
    return Scaffold(
              ...
              builder: (context) {
                ...
                if (orientation == NativeDeviceOrientation.landscapeLeft || orientation == NativeDeviceOrientation.landscapeRight) {
                  return Row(
                    ...
                    children: [
                      Expanded(child: Image.asset(url_image)),
                      Expanded(
                          child: RotatedBox(
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      Expanded(
                          child: RotatedBox(
                              quarterTurns: (orientation == NativeDeviceOrientation.portraitUp ? 0 : 2),
                              child: CameraPreview(_controller))),
                    ],
                  );
                }
      ...
      floatingActionButton: FloatingActionButton(
        child: (pressedButton ? Icon(Icons.all_inclusive) : Icon(Icons.camera_alt)),
