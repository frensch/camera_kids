...
class CorrectRotation extends StatefulWidget {
  ...
  const CorrectRotation(
      {Key key, this.cameraController, this.urlImage, this.takePicture})
      : super(key: key);

  StateCorrectRotation createState() => StateCorrectRotation(
      this.cameraController, this.urlImage, this.takePicture);
}
      ...
      builder: (context) {
        ...
        child:CameraPreview(cameraController))))),
              FloatingActionButton(
                ...
                backgroundColor:
                    (CorrectRotation.pressedButton ? Colors.grey : Colors.cyan),
